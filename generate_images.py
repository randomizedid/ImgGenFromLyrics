...
def generate_images(
        output_dir_name='output_images',  # Name of the output directory.
        ...
        prompt="three dice generating random numbers",  # Unleash your inner neural network whisperer.
        num_inference_steps=120,  # More (e.g. 100, 200 etc) can create slightly better images.
        guidance_scale=7,  # Complete black magic. Usually somewhere between 3-10 is good - but experiment!
        seed=27,  # I love it more than 42. What are you going to do about it? (submit a PR? :P)
